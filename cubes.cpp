...
namespace
{
	...
	static CircleVertex s_cubeVertices[] =
	{
	...
	public:
		...
		void init(int32_t _argc, const char *const *_argv, uint32_t _width, uint32_t _height) override
		{
			...
			// m_vbh = bgfx::createVertexBuffer(bgfx::makeRef(s_cubeVertices, sizeof(s_cubeVertices)), CircleVertex::ms_layout);
			createCircleVB(&m_vbh, 1, 0xffffffff, 4);

			// Create static index buffer for point list rendering.
			// Static data can be passed with bgfx::makeRef
			// m_ibh = bgfx::createIndexBuffer(bgfx::makeRef(s_cubePoints, sizeof(s_cubePoints)));
			createCircleIB(&m_ibh, 4);
